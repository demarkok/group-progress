...
(defn attempts
	"Returns a map of attempts by adding new attempts for the specified users to the
	cache. Cache is used to reduce traffic and number of GET requests.
	Requests are performed in parallel and consumer should consider using function
	shutdown-agents at the end of a calling script."
	[cache mccme-ids]
